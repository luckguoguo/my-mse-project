...
<table width="80%">
	...
	<tr>
		...
		<td>
			...
			<input type="button" value="<@spring.messageText "veterinarian.detail.btn.interrogation", "Interrogation" />" onclick="javascript:location.href='${contextPath}/petowner/interrogation/form?veterinarianId=${veterinarian.id}';" />
			<#else>
