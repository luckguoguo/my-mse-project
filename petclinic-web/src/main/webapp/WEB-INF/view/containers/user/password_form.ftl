...
<table>
	<tr>
		<td><@spring.messageText "user.password.form.label.origPassword", "Original Password" /></td>
		<td>
	...
	<tr>
		<td><@spring.messageText "user.password.form.label.newPassword", "New Password" /></td>
		<td>
	...
	<tr>
		<td><@spring.messageText "user.password.form.label.confirmNewPassword", "Confirm New Password" /></td>
		<td>
