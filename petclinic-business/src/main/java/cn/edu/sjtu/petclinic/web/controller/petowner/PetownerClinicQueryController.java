...
@Controller
public class PetownerClinicQueryController extends AbstractController {

	@RequestMapping(value = "/petowner/clinic/query/form", method = RequestMethod.GET)
	public String getClinicQueryForm(HttpServletRequest request, Model model) {
		...
		return ViewNames.FORWARD_PETOWNER_CLINIC_QUERY_FORM;
	}
	
	@RequestMapping(value = "/petowner/clinic/query/result", method = RequestMethod.GET)
	public String queryClinic(HttpServletRequest request, Model model, ClinicQuery query) {
		...
		return ViewNames.FORWARD_PETOWNER_CLINIC_QUERY_RESULT;
	}
	
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/petowner/clinic/{clinicId}", method = RequestMethod.GET)
	public String queryClinicDetail(HttpServletRequest request, @PathVariable Long clinicId, Model model) {
		...
		return ViewNames.FORWARD_PETOWNER_CLINIC_QUERY_DETAIL;
	}
