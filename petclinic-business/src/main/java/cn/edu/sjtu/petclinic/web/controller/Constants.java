...
public class Constants {
	...
	public static final String MODEL_NAME_CLINIC = "clinic";
	...
	public static final String MODEL_NAME_INTERROGATION = "interrogation";
	public static final String MODEL_NAME_INTERROGATIONS = "interrogations";
	public static final String MODEL_NAME_DIAGNOSIS = "diagnosis";
